...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-neutral-500 relative">
      <div className="fixed inset-0 opacity-5 pointer-events-none" style={{ backgroundImage: 'url(https://cdn.poehali.dev/files/6a367fa8-b448-4057-8ed0-4d2614046ae3.png)', backgroundSize: '300px', backgroundPosition: 'center', backgroundRepeat: 'repeat' }} />
