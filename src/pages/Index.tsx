        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card className="text-center border-2 hover:border-primary transition-colors">
              ...
              <CardContent>
                <p className="text-lg font-semibold mb-2">info@kassatech.ru</p>
            ...
            <Card className="text-center border-2 hover:border-primary transition-colors">
              ...
              <CardContent>
                <p className="text-lg font-semibold mb-2">г. Подольск</p>
                <p className="text-sm text-muted-foreground">ул. Маштакова, д. 12</p>
              </CardContent>
            </Card>
          </div>
        </div>
